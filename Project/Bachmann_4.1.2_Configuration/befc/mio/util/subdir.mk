...
../befc/mio/util/ModuleFactory.cpp 

OBJS += \
./befc/mio/util/M1Scan.o \
./befc/mio/util/ModuleFactory.o 

CPP_DEPS += \
./befc/mio/util/M1Scan.d \
./befc/mio/util/ModuleFactory.d 


# Each subdirectory must supply rules for building sources it contributes
befc/mio/util/%.o: ../befc/mio/util/%.cpp
	@echo 'Building file: $<'
